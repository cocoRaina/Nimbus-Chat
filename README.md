...
- **白天只有早晨第一条冷写** — 安静时段（00:00–08:00 北京）让缓存夜里过期；早上第一条消息冷写一次（~¥1.5），之后 ping 全天跟随，中途聊天自动后延，直到午夜。每天固定成本：¥1.32 冷写 + ~¥1.3 全天热读 ping ≈ ¥2.6，无午后额外冷写，见 [caching.md §9](docs/caching.md)
