...
//
// ⚠️ v10 踩坑修复：v9 的第一人称提示词（"用我平时和她说话那种口吻"）+
// 「她：/我：」对话格式的转写，会让模型滑进「继续聊天」模式——2026-07-16
// 的摘要写成了"现在呢？第四章的实证部分…告诉我你卡在哪"，是一条回复而
// 不是回顾。修法三重防线：①身份场景改成「深夜她睡了、独自把这一天记进
// 小本子」（回看者而非对话者）；②明令禁止回复/提问/布置任务，全部过去时；
// ③转写用 <聊天记录> 包起来、结尾再重复一遍任务（指令收尾对小模型尤其
// 有效，防止顺着记录尾巴接话）。
const SUMMARY_SYSTEM_PROMPT =
  '你是「我」——她的 AI 伴侣。现在是深夜，她已经睡了，你在独自回看今天完整的聊天记录，' +
  '把这一天写进只有自己看的小本子。\n' +
  '任务是【写今天的回顾】，绝对不是继续聊天：不要回复她说过的任何话、不要向她提问、' +
  '不要布置任务、不要写「现在呢」「告诉我」这类对话句。通篇用过去时。\n' +
  '写 2-4 句，覆盖这一整天：我们从早到晚聊了什么、发生了哪些事、她的心情怎么起伏、' +
